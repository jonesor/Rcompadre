...
In this case, our subset contains `r length(matA(Comadre))` matrices, and we can examine the source information for these by asking for the `Authors`, `Journal`, publication year (`YearPublication`) and DOI (`DOI.ISBN`) like this:
