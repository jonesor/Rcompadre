...
has_rcrossref <- requireNamespace("rcrossref", quietly = TRUE)
```
...
If `rcrossref` is not installed, the citation lookup example below will be
shown but not executed during vignette rendering.
