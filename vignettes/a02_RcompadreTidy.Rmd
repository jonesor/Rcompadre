...
# popdemo is a Suggests dependency; skip chunks that need it if unavailable
has_popdemo <- requireNamespace("popdemo", quietly = TRUE)
```
...
library(dplyr)
library(ggplot2)
if (requireNamespace("popdemo", quietly = TRUE)) library(popdemo)
```
