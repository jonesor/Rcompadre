...
Alternatively, the function `cdb_fetch` will automatically download the latest version of COMPADRE or COMADRE from the website, and ensure it is of the correct class. For example:
...
```{r Check species3}
compadre_succisa<- cdb_check_species(Compadre, "Succisa pratensis", returnDatabase = TRUE)
compadre_succisa
```
